...
public:
    ...
    //Hindlegs---------------------------------------------------------------------------
    double lhlHipInit = 180;//150;  //hind left hip
    double rhlHipInit = 180;//30;   //hind right hip
    double lhlCoilInit = 180;//40;  //hind left Coil
    double rhlCoilInit = 180;//40;  //hind right Coil
    //TODO save initControlled positions here
    //Forelegs---------------------------------------------------------------------------
    double lflHipInit = 180;//90;   //fore left Hip
    double rflHipInit = 180;//90;   //fore right Hip
    double lflCoilInit = 180;//80;  //fore left Coil
    double rflCoilInit = 180;//80;  //fore right coil
    //calibration offsets----------------------------------------------------------------
    const double flOffset = 0;        //offset value for foreleft hip servo
...
#else
    //Hindlegs---------------------------------------------------------------------------
    double lhlHipInit = 150;  //hind left hip
    double rhlHipInit = 30;   //hind right hip
    double lhlCoilInit = 40;  //hind left Coil
    double rhlCoilInit = 40;  //hind right Coil
    //Forelegs---------------------------------------------------------------------------
    double lflHipInit = 90;   //fore left Hip
    double rflHipInit = 90;   //fore right Hip
    double lflCoilInit = 80;  //fore left Coil
    double rflCoilInit = 80;  //fore right coil
    //calibration offsets----------------------------------------------------------------
    const double flOffset=0;        //offset value for foreright hip servo
    const double frOffset=0;        //offset value for foreright hip servo
    const double hlOffset=0;        //offset value for hindleft hip servo
    const double hrOffset=0;        //offset value for hindright hip servo
#endif
    ...
    void getHindLegDims(double &h1, double &h2, double &h3, double &h3i) {
        h1 = hl1;
        h2 = hl2;
        h3 = hl3;
        h3i = ht3i;
    ...
    void getForeLegDims(double &h1, double &h2, double &h3, double &h3i) {
        h1 = fl1;
        h2 = fl2;
        h3 = fl3;
        h3i = ft3i;
